...
WebUI.callTestCase(findTestCase('CURA/Booking'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_CURA Healthcare Service/div_23102023'), 0)
